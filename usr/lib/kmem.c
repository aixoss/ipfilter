...
/*                                                                        */
/* 53ipfl53H src/ipfl/usr/lib/kmem.c 1.1                                  */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
static char sccsid[] = "@(#)19  1.2  src/ipfl/usr/lib/kmem.c, ipflt, 53ipfl53H, 0619A_53ipfl53H 5/10/06 14:44:30";
/*
...
#endif
#if defined(linux) || defined(__osf__) || defined(__sgi) || defined(__hpux) || defined(AIX)
# include <stdlib.h>
#endif
